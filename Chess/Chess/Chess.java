...
public class Chess{
    ...
    public static void main(String[] args){
        ...
        while (true){
            // Prompts the player for the move and parse it
    ...
    public void setDefaultBoard(){
        // Initializes the default board according to chess
    ...
    public void setPiece(int position, Piece piece, boolean color){
        // Initializes information about the piece
